...
abstract public class BaseNNAIPlayer implements Player {
	...
	protected IHandIteratorFactory<BaseNNAIPlayer> handIteratorFactory;
	...
	public BaseNNAIPlayer(Color color, GameCondition gameCondition,
			IHandIteratorFactory<BaseNNAIPlayer> handIteratorFactory)
	{
		self = color;
		...
		this.handIteratorFactory = handIteratorFactory;
	}
	...
	protected NNMoveEvaluation evalute(Board board, Color player, Optional<Point> move)
	{
